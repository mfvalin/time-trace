...
tests: trace_test_f trace_test_c
...
trace_test_f: time_trace_c.c time_trace_f.F90 time_trace.h time_trace.hf
...
clean:	
	rm -f *.o *.mod time_list_*.txt time_list_*.dat trace_test_c trace_test_f libtimetrace.a
